...
class Config(metaclass=Singleton):
    ...
    def __init__(self):
        ...
        self.translate_api_name = os.getenv("TRANSLATE_API_NAME")
        self.translate_api_id = os.getenv("TRANSLATE_API_ID")
    ...
    def set_translate_api_name(self, value: str):
        """Set the Translate API name value."""
        self.translate_api_name = value

    def set_translate_api_key(self, value: str):
        """Set the Translate API key value."""
        self.translate_api_key = value

    def set_translate_api_id(self, value: str):
        """Set the Translate API id value."""
        self.translate_api_id = value
